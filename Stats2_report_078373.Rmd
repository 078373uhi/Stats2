...
tidy_BN_count %>%
  ...
  arrange(desc(tf_idf)) 
```
When analysed for word importance it is seen that "enemy's" has by far the highest importance rating follwed by "Koenigsberg" with these being the two most important words for the The British Navy in Battle.  "Breech" was the most important word for The British Navy Book while or Flag and Fleet it was "Spaniards".

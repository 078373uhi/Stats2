...
```{r commsvert, include=FALSE}
V(navy_graph)

``` 

There are 193 edges.
```{r commsedge, include=FALSE}
E(navy_graph)

``` 

These graphs show the number of unique other vessels that any particular vessel is communicating with. This shows outgoing, incoming and total communications.
```{r commsdegree, include=FALSE}
